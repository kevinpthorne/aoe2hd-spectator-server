...
class Connection
{
    ...
    private function handshake($data)
    {
        ...
        $tmp = explode("?", $path);
        $path = $tmp[0];
        $this->processQueryParameters($tmp[1]);
    ...
    public function close($statusCode = 1000)
    {
        ...
        $this->log("Requests:" . $this->_requests);
    }
    ...
    private function hybi10Decode($data)
    {
        ...
        //$this->log("first " . $firstByteBinary);
        $secondByteBinary = sprintf('%08b', ord($data[1]));
        //$this->log("sec " . $secondByteBinary);
    ...
    private function processQueryParameters(string $queryString)
    {
        foreach (explode("&", $queryString) as $parameterString)
        {
            $tmp = explode("=", $parameterString);
            $this->queryParameters[urldecode($tmp[0])] = urldecode($tmp[1]);
        }
    }
