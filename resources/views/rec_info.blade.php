...
$filename = __DIR__ . "/../../../public/recs/HD 1v1 Arabia - echospot Deckard.aoe2record";
...
if (!function_exists('getResearchImage')) {
    ...
    {
        $path = __DIR__ . '/../../vendor/recanalyst/resources/images/researches/' . $research->id . '.png';
        if (is_file($path)) {
        ...
        <div role="tabpanel" class="tab-pane Category active" id="general">
            <div class="General">
                <dl class="General-info dl-horizontal">
                    ...
                    <dt>PoV</dt>
                    <dd><?= isset($pov) ? e($pov->name) : 'Unknown' ?></dd>
                </dl>
